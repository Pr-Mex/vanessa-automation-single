	...
	Для каждого Элем Из Массив Цикл
		...
		Иначе
			Если НЕ ПустаяСтрока(Элем) Тогда 
				Попытка
					Результат.Вставить(УбратьЭкранированиеСпецСимволовПараметрЗапуска(Элем),Истина);
				Исключение
					ТекстСообщения = "Не вышло получить значение из строки запуска: %1";
