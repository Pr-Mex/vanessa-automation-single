...
Функция ВстроенныеБиблиотеки()
	...
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_SikuliXServer");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Smoke_InputBasedOn");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_НесколькихКлиентовТестирования");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_РаботаСTestClient");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ОткрытьTestClient");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ПодключениеНесколькихКлиентовТестированияБиблиотека");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ПроверкаЗначенияМакета");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ПроверкаИсключенияШага");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_РаботаСИнтерфейсом");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_РаботаСИнтерфейсомДополнительный");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_РаботаСОкномСообщений");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_РаботаСТаблицами");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_СохранитьМакетИзОбработкиВФайл");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ФильтрФормыСписка");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ФильтрФормыСпискаЭкспорт");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Load1000ItemsfromMxl");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_VBForm");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_VBManager");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ВыводТекста");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Док_ГененерацияEPFLib");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Док_ЗагрузкаФичLib");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Док_ОткрытиеФормыLib");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Док_ПередачаПараметровВСценарийLib");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Док_ПроверитьЕстьЛиОкноСОшибкойLib");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Док_РаботаСПеременнымиКонтекстИКонтекстСохраняемыйLib");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ЗагрузкаФичи");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ЗаполнитьНастройкиЗаписиВидео");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ЗапускПростогоСценарияTestClient");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ИнтервалВыполненияШага");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Константы");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ОстановитьВыполнениеШагов");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ОткрытьФормуЧерезКоманду");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Плагины");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ПримерНаписанияФичиLib");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_РазвернутьВеткиДереваVB");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_СозданиеFixtures");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_СозданиеFixturesПоМакетуОбработкиФичи");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_СозданиеЗаписейРС");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_СуществованиеЭлементов");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ТестированиеVA");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_УстановкаСистемныхПараметров");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ВстроенныйЯзык");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ЗапускПриложений");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Логирование");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Обновление_нумерации_объектов");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_КнопкаНажималкаОбычныйИнтерфейс");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ПакетныйРежим");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_СделатьПаузу");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_СделатьПаузуОФ");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ПеременныеОкружения");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_РаботаСФайлами");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ДоступнстьРоли");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Условие");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_ПереборМассива");
	Массив.Добавить("ВнешняяОбработка.VanessaAutomationsingle.Форма.Тест_Цикл");
