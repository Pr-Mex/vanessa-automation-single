...
Функция ОШ_ЯЗапоминаюЗначениеВПеременную()
	...
	Результат.ОписаниеШага = "Установка значения в переменную, для последующего использования в теле скрипта. Значением может быть простой тип, или таблица или многострочная строка";
